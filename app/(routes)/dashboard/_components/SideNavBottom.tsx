...
const SideNavBottom = ({ onClickFileCreate, totalFilesCount }: any) => {
  ...
  const { FREE_TIER_FILE_LIMIT } = Constant
  ...
  return (
    <div>
      ...
      <Dialog>
        ...
        {totalFilesCount < FREE_TIER_FILE_LIMIT ?
          <DialogContent>
            <DialogHeader>
      ...
      <Progress value={(totalFilesCount / FREE_TIER_FILE_LIMIT) * 100} className='h-4 w-full bg-gray-200 rounded-full mt-5 ' />
